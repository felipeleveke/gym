  ...
  return (
    ...
    >
      <div
        data-sidebar="sidebar"
        className={cn(
          "duration-200 relative flex h-full w-[--sidebar-width] flex-col border-r bg-sidebar transition-[width] ease-linear",
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] after:-translate-x-1/2 after:bg-sidebar-border after:transition-all after:duration-200 group-data-[side=left]:-right-4 group-data-[side=right]:left-0",
          "[[data-side=left]_&]:cursor-w-resize [[data-side=right]_&]:cursor-e-resize",
          "[[data-side=left][data-state=collapsed]_&]:cursor-e-resize [[data-side=right][data-state=collapsed]_&]:cursor-w-resize",
          "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full group-data-[collapsible=offcanvas]:hover:w-6",
    ...
    return (
      <button
        ...
        className={cn(
          ...
          "peer-data-[size=sm]/sidebar-group-action:top-2.5",
...
>(({ asChild = false, size = "default", isActive = false, className, ...props }, ref) => {
